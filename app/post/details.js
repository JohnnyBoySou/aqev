...
import { Column, Row, Title, Label, Scroll, Main, Spacer } from "@/constants/Global";
        ...
        <Main>
              <Column>
                ...
                <Row style={{ marginTop: -2, }}>
                    ...
                    <Pressable onPress={() => navigation.goBack()} style={{ flexGrow: 1, backgroundColor: color.secundary, borderRadius: 16, borderTopLeftRadius: 0, justifyContent: 'center', alignItems: 'center', }}>
