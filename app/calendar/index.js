...
import { Column, Label, Main, Title, Scroll, Row } from "@/constants/Global";
...
export default function CalendarPage({ navigation }) {
    ...
    return (
        <Main>
            ...
            <BottomSheet ref={adjustDate} adjustToContentHeight handlePosition='inside'>
                <BottomSheetScrollView style={{ paddingVertical: 20, }}>
